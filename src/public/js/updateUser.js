...
function updateUerInfo() {
  $('#input-change-avatar').bind('change', function() {
    ...
    if(typeof (FileReader) != "undefined"){
      // hiện ảnh vừa được chọn update trước khi update
  ...
  $("#input-change-username").bind("change",function(){
    // lấy dữ liệu của form và validate rồi gắn vào userInfo
...
$(document).ready(function() {
  // Trước khi chạy mấy hàm kia thì lưu lại avatarSrc và thông tin proginUserIngo
  ...
  $('#input-btn-cancel-update-user').bind('click', function(){
    // cancel khi cập nhật user và sử lại các thông tin
    userAvatar = null;
    userInfo = {};
